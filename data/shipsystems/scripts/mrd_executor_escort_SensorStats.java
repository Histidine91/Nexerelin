...
public class mrd_executor_escort_SensorStats implements ShipSystemStatsScript {

	public static final float SENSOR_RANGE_PERCENT = 3.2f;
	public static final float WEAPON_RANGE_PERCENT = 1.9f;
