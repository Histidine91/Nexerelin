...
public class mrd_omega_escort_SensorStats implements ShipSystemStatsScript {

	public static final float SENSOR_RANGE_PERCENT = 3.4f;
	public static final float WEAPON_RANGE_PERCENT = 2.3f;
