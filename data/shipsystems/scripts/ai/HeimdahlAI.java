...
import data.shipsystems.scripts.HeimdahlSystem;
import java.util.*;
...
public class HeimdahlAI implements ShipSystemAIScript
{
    ...
    public void advance(float amount, Vector2f missileDangerDir, Vector2f collisionDangerDir, ShipAPI target)
    {
        ...
        for (Iterator nearby = CombatUtils.getShipsWithinRange(ship.getLocation(),
                HeimdahlSystem.PULSE_RANGE).iterator(); nearby.hasNext();)
        {
