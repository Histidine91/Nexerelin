...
public class Valhalla {
	...
	public void generate(SectorAPI sector) {
		...
		system.addRingBand(star, "misc", "rings2", 256f, 2, Color.white, 256f, 3100, 190f, null, null);
		system.addAsteroidBelt(star, 100, 3000, 256, 150, 250, Terrain.ASTEROID_BELT, "The Valkyries");
		
			// Valkyrie jump
			JumpPointAPI jumpPoint = Global.getFactory().createJumpPoint("valkyrie_jump", "Valkyrie Jump");
			OrbitAPI orbit = Global.getFactory().createCircularOrbit(star, 180, 3325, 75);
			jumpPoint.setOrbit(orbit);
			jumpPoint.setStandardWormholeToHyperspaceVisual();
			system.addEntity(jumpPoint);
		
		system.addRingBand(star, "misc", "rings1", 256f, 2, Color.white, 256f, 3450, 200f, null, null);
		system.addAsteroidBelt(star, 100, 3400, 256, 150, 250, Terrain.ASTEROID_BELT, "The Valkyries");
		
	// Yggdrasil, largest gas giant in the system.
		PlanetAPI val2 = system.addPlanet("yggdrasil", star, "Yggdrasil", "gas_giant", 230, 350, 7200, 250);
		...
		val2.applySpecChanges();
			...
			val2c.setCustomDescriptionId("planet_raesvelg");
				...
				yggdrasilL4.setCircularOrbit(star, 230 + 60, 7200, 250);
				yggdrasilL5.setCircularOrbit(star, 230 - 60, 7200, 250);
		
				
	// Niflheim
		PlanetAPI val3 = system.addPlanet("niflheim", star, "Niflheim", "ice_giant", 230, 250, 14000, 450);
...
//		initStationCargo(mimir_station);
	...
	// orbited by station, relay, and asteroid field each 1/3rd orbit off from one another.
		PlanetAPI val4 = system.addPlanet("ragnar", star, "Ragnar", "star_red", 45, 280, 17000, 1000);
		...
		JumpPointAPI jumpPoint_ragnar = Global.getFactory().createJumpPoint("ragnar_jump", "Ragnar Jump");
		...
		system.addRingBand(val2, "misc", "rings1", 256f, 2, Color.white, 256f, 1100, 40f, Terrain.RING, null);
