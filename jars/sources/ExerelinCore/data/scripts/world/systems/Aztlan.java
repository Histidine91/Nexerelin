...
public class Aztlan {
	...
	public void generate(SectorAPI sector) {
		...
		system.addRingBand(aztlan_star, "misc", "rings1", 256f, 2, Color.white, 256f, 3100, 70f, null, null);
	...
	// Chicomoztoc & friends
		...
		aztlan2.setInteractionImage("illustrations", "urban03");
			...
			system.addRingBand(aztlan2, "misc", "rings1", 256f, 3, Color.white, 256f, 500, 33f, Terrain.RING, null);
			...
			JumpPointAPI jumpPoint_aztlan = Global.getFactory().createJumpPoint("aztlan_jump_point_alpha", "Aztlan Inner System Jump");
	...
	// Tlalocan System
		PlanetAPI aztlan3 = system.addPlanet("tlalocan", aztlan_star, "Tlalocan", "ice_giant", 130, 290, 11500, 500);
		...
		aztlan3.applySpecChanges();
			...
			system.addRingBand(aztlan3, "misc", "rings1", 256f, 0, Color.white, 256f, 630, 43f, Terrain.RING, null);
			...
			SectorEntityToken coatl_station = system.addCustomEntity("coatl_station", "Coatl Station", "station_side02", "hegemony");
		...
		tlalocan_L5_nebula.setCircularOrbit(aztlan_star, 130 - 60, 11500, 500);
		tlalocan_L4_nebula.setCircularOrbit(aztlan_star, 130 + 60, 11500, 500);
		
		// and a jump point hidden in Tlalocan's L5.
		JumpPointAPI jumpPoint_aztlan2 = Global.getFactory().createJumpPoint("aztlan_jump_point_beta", "Aztlan Outer System Jump");
		OrbitAPI orbit2 = Global.getFactory().createCircularOrbit(aztlan_star, 130 + 60, 11500, 500);
		...
		PlanetAPI aztlan4 = system.addPlanet("toci", aztlan_star, "Toci", "frozen", 30, 80, 14000, 900);
