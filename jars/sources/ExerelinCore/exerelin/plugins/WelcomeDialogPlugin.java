...
public class WelcomeDialogPlugin implements InteractionDialogPlugin
{
    ...
    private void showText(Integer stage)
    {
        if(stage == 0)
        {
            ...
            this.textPanel.addParagraph("Your goal is to conquer this sector for the " + Global.getSector().getFaction(SectorManager.getCurrentSectorManager().getPlayerFactionId()).getDisplayName() + ".");
            this.textPanel.addParagraph("");
        }
    }
